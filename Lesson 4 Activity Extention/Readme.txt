...
Update your code to allow the user to have an infinite number of guesses, until they get the answer right

Make sure the program can come to a stop once the user guesses the correct answer

If you get stuck at any point, rewatch the videos
